<template>
	<transition name="slide-fade">
		<div
			...
			class="polymorphic is-flex is-align-items-center _dropdown cursor-pointer"
		>
			<b-dropdown
				v-model="currentOptionProxy"
				:max-height="240"
				:mobile-modal="false"
				animation="fade1"
				aria-role="list"
			...
			>
				<template #trigger="{ active }">
					<div class="is-text auto-height pl-0 pt-0 pb-0 is-flex is-align-items-center">
						<b-icon :icon="icon" class="mr-1 _dropdown__typeIcon" custom-size="mdi-18px" pack="casa">
						</b-icon>
						<span class="has-text-full-03">
							{{ $t(currentOption.name) }}
						</span>
						<b-icon
